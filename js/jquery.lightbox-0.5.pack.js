...
//alert('js/jquery.lightbox-0.5.pack.js');
		settings=jQuery.extend(
			{
			overlayBgColor:'#000',overlayOpacity:0.8,fixedNavigation:false,imageLoading:'images/lightbox-ico-loading.gif',imageBtnPrev:'images/lightbox-btn-prev.gif',imageBtnNext:'images/lightbox-btn-next.gif',imageBtnClose:'images/lightbox-btn-close.gif',imageBlank:'images/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:100,txtImage:'Image',txtOf:'of',keyToClose:'c',keyToPrev:'p',keyToNext:'n',imageArray:[],activeImage:0
		} ,settings);
		...
		function _set_interface()
			...
			$('#jquery-overlay').css(
				{
				backgroundColor:settings.overlayBgColor,opacity:settings.overlayOpacity,width:arrPageSizes[0],height:arrPageSizes[1]
			}
			).fadeIn();
		...
		/*	$('#lightbox-nav,#lightbox-nav-btnPrev,#lightbox-nav-btnNext').click(function()
			...
			$(window).resize(function()
				...
				$('#jquery-overlay').css(
					{
					width:arrPageSizes[0],height:arrPageSizes[1]
				}
				);
				var arrPageScroll=___getPageScroll();
				$('#jquery-lightbox').css(
		...
		function _resize_container_image_box(intImageWidth,intImageHeight)
			...
			$('#lightbox-container-image-box').animate(
				{
				width:intCurrentWidth2,height:intHeight
...
function pictureResizing() {
	...
	//			'border':'3px red solid'
		...
		}else if (intCurrentScreenWidth<900 && intCurrentHeight2<intCurrentWidth4){
			$('#lightbox-image').css({
	...
	else if(	intCurrentHeight2<intCurrentWidth4 && intCurrentScreenWidth<intCurrentWidth4){
